  ...
  else if(code_seen('M'))
  {
    ...
    case 105 : // M105
      ...
      if(code_seen('T')) {
        ...
        VOICE_MESSAGEPGM(MSG_ERR_NO_THERMISTORS);
      #endif
      #ifdef PIDTEMP
        SERIAL_PROTOCOLPGM(" @:");
    ...
    {// M109 - Wait for extruder heater to reach target.
      ...
      bool target_direction = isHeatingHotend(tmp_extruder); // true if heating, false if cooling
        ...
        VOICE_MESSAGEPGM(MSG_HEATING_COMPLETE);
        starttime=millis();
        previous_millis_cmd = millis();
      }
      break;
    case 190: // M190 - Wait for bed heater to reach target.
        ...
        VOICE_MESSAGEPGM(MSG_BED_HEATING);
        if (code_seen('S')) setTargetBed(code_value());
        codenum = millis(); 
        while(isHeatingBed()) 
        {
